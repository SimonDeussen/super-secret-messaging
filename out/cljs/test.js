...
var G__1212 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__1212,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__1212;
}
});
...
var len__4411__auto___1217 = arguments.length;
var i__4412__auto___1218 = (0);
while(true){
if((i__4412__auto___1218 < len__4411__auto___1217)){
args__4414__auto__.push((arguments[i__4412__auto___1218]));

var G__1219 = (i__4412__auto___1218 + (1));
i__4412__auto___1218 = G__1219;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq1214){
var G__1215 = cljs.core.first.call(null,seq1214);
var seq1214__$1 = cljs.core.next.call(null,seq1214);
var G__1216 = cljs.core.first.call(null,seq1214__$1);
var seq1214__$2 = cljs.core.next.call(null,seq1214__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__1215,G__1216,seq1214__$2);
});
...
var map__1221 = m;
var map__1221__$1 = ((((!((map__1221 == null)))?((((map__1221.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1221.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1221):map__1221);
var file = cljs.core.get.call(null,map__1221__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__1221__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__1221__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__1221,map__1221__$1,file,line,column){
return (function (p1__1220_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__1220_SHARP_));
});})(map__1221,map__1221__$1,file,line,column))
...
var temp__4657__auto___1223 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___1223)){
var message_1224 = temp__4657__auto___1223;
cljs.core.println.call(null,message_1224);
} else {
}
...
var temp__4657__auto___1225 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___1225)){
var message_1226 = temp__4657__auto___1225;
cljs.core.println.call(null,message_1226);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__1227 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1227),"/"].join('');
} else {
return G__1227;
}
})();
...
var G__1229 = exception.stack;
var G__1229__$1 = (((G__1229 == null))?null:clojure.string.split_lines.call(null,G__1229));
var G__1229__$2 = (((G__1229__$1 == null))?null:cljs.core.get.call(null,G__1229__$1,depth));
if((G__1229__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__1229__$2);
}
} else {
...
var vec__1230 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__1230,(0),null);
var column = cljs.core.nth.call(null,vec__1230,(1),null);
var vec__1233 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__1233,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__1233,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__1233,(2),null);
...
var m__$1 = (function (){var G__1236 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__1236__$1 = (((G__1236 instanceof cljs.core.Keyword))?G__1236.fqn:null);
switch (G__1236__$1) {
case "fail":
...
var G__1240 = (function (){var G__1239 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__1239);
} else {
return G__1239;
}
})();
...
return cljs.core.vary_meta.call(null,G__1241,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e1242){var e = e1242;
var G__1243 = e;
var G__1243__$1 = (((G__1243 instanceof cljs.core.Keyword))?G__1243.fqn:null);
switch (G__1243__$1) {
...
var vec__1245 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__1245,(0),null);
var types = vec__1245;
...
return cljs.core.map.call(null,(function (p__1248){
var vec__1249 = p__1248;
var ns = cljs.core.nth.call(null,vec__1249,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__1249,(1),null);
return ((function (vec__1249,ns,vars__$1){
return (function (){
...
var G__1252 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__1252,G__1252__$1,env,once_fixtures,each_fixtures,vec__1249,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__1252,G__1252__$1,env,once_fixtures,each_fixtures,vec__1249,ns,vars__$1){
return (function (){
var seq__1253 = cljs.core.seq.call(null,vars__$1);
var chunk__1254 = null;
var count__1255 = (0);
var i__1256 = (0);
while(true){
if((i__1256 < count__1255)){
var v = cljs.core._nth.call(null,chunk__1254,i__1256);
var temp__4657__auto___1258 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___1258)){
var t_1259 = temp__4657__auto___1258;
each_fixture_fn.call(null,((function (seq__1253,chunk__1254,count__1255,i__1256,t_1259,temp__4657__auto___1258,v,each_fixture_fn,G__1252,G__1252__$1,env,once_fixtures,each_fixtures,vec__1249,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1259)));
});})(seq__1253,chunk__1254,count__1255,i__1256,t_1259,temp__4657__auto___1258,v,each_fixture_fn,G__1252,G__1252__$1,env,once_fixtures,each_fixtures,vec__1249,ns,vars__$1))
);
} else {
}

var G__1260 = seq__1253;
var G__1261 = chunk__1254;
var G__1262 = count__1255;
var G__1263 = (i__1256 + (1));
seq__1253 = G__1260;
chunk__1254 = G__1261;
count__1255 = G__1262;
i__1256 = G__1263;
...
var temp__4657__auto__ = cljs.core.seq.call(null,seq__1253);
if(temp__4657__auto__){
var seq__1253__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1253__$1)){
var c__4231__auto__ = cljs.core.chunk_first.call(null,seq__1253__$1);
var G__1264 = cljs.core.chunk_rest.call(null,seq__1253__$1);
var G__1265 = c__4231__auto__;
var G__1266 = cljs.core.count.call(null,c__4231__auto__);
var G__1267 = (0);
seq__1253 = G__1264;
chunk__1254 = G__1265;
count__1255 = G__1266;
...
var v = cljs.core.first.call(null,seq__1253__$1);
var temp__4657__auto___1268__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___1268__$1)){
var t_1269 = temp__4657__auto___1268__$1;
each_fixture_fn.call(null,((function (seq__1253,chunk__1254,count__1255,i__1256,t_1269,temp__4657__auto___1268__$1,v,seq__1253__$1,temp__4657__auto__,each_fixture_fn,G__1252,G__1252__$1,env,once_fixtures,each_fixtures,vec__1249,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1269)));
});})(seq__1253,chunk__1254,count__1255,i__1256,t_1269,temp__4657__auto___1268__$1,v,seq__1253__$1,temp__4657__auto__,each_fixture_fn,G__1252,G__1252__$1,env,once_fixtures,each_fixtures,vec__1249,ns,vars__$1))
);
} else {
}

var G__1270 = cljs.core.next.call(null,seq__1253__$1);
var G__1271 = null;
var G__1272 = (0);
var G__1273 = (0);
seq__1253 = G__1270;
...
});})(each_fixture_fn,G__1252,G__1252__$1,env,once_fixtures,each_fixtures,vec__1249,ns,vars__$1))
);
});})(each_fixture_fn,G__1252,G__1252__$1,env,once_fixtures,each_fixtures,vec__1249,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1252__$1)].join('')));

}
})());
});
;})(vec__1249,ns,vars__$1))
